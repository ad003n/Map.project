...
inline QGeoCoordinate NewCoordinate(const QGeoCoordinate &coord, double azimuth, double distance)
{
    constexpr double earthRadius = 6378137.0; // Радиус Земли в метрах
//qDebug()<< "azimuth new coordinate"<<azimuth;
...
inline double calculate_azimuth(const QGeoCoordinate &point1, const QGeoCoordinate &point2)
{
